...
type IconName = 'overview' | 'id' | 'members' | 'community' | 'saved' | 'mentoring' | 'career' | 'wealth' | 'wallet' | 'membership' | 'notifications' | 'support' | 'admin';

const links: Array<{ label: string; href: string; icon: IconName }> = [
  { label: 'Overview', href: '/dashboard', icon: 'overview' }, { label: 'CrewID', href: '/crew-id', icon: 'id' }, { label: 'Members', href: '/members', icon: 'members' }, { label: 'Community', href: '/community', icon: 'community' }, { label: 'Saved', href: '/saved', icon: 'saved' }, { label: 'Mentoring', href: '/mentoring', icon: 'mentoring' }, { label: 'Career', href: '/career', icon: 'career' }, { label: 'CrewWealth', href: '/wealth', icon: 'wealth' }, { label: 'Crew Wallet', href: '/wallet', icon: 'wallet' }, { label: 'Membership', href: '/membership', icon: 'membership' }, { label: 'Notifications', href: '/notifications', icon: 'notifications' }, { label: 'Support', href: '/support', icon: 'support' }, { label: 'Admin', href: '/admin', icon: 'admin' },
];
