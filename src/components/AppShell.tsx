...
type IconName = 'overview' | 'id' | 'members' | 'community' | 'career' | 'wealth' | 'wallet' | 'membership' | 'notifications' | 'support' | 'admin';
    ...
    <main className="appPage">
      ...
      <section className="appContent">
        <div className="appUtilityBar" aria-label="Quick actions">
          ...
          <Link className="appUtilityIcon" href="/notifications" aria-label="Open notifications"><UtilityIcon type="notifications" /></Link>
