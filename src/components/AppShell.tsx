  ...
  return (
    <main className="appPage">
      <aside className="sidebar">
        ...
        <div className="sideBottom"><span className="avatar">JS</span><div><b>Member</b><small>NextWave Crew</small></div></div>
      </aside>
      <section className="appContent"><div className="appHeader"><div><span className="microLabel">{kicker}</span><h1>{title}</h1></div><div className="statusPill"><span className="liveDot"/> Member workspace</div></div>{children}</section>
    </main>
  );
}
